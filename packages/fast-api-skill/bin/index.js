...
async function main() {
  console.log();
  console.log(colors.bold('⚡ FAST API Skill Installer'));
  console.log(colors.cyan('   Payment SDK for AI agents'));
  console.log();
  ...
  // Success message
  console.log();
  console.log(colors.green('✅ FAST API skill installed successfully!'));
  console.log();
